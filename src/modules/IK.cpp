...
struct IK {
  ...
  void reset(glm::vec3 root_position) {
    position[IK::HL] = glm::vec3(0,0,0); lock[IK::HL] = 0; height[IK::HL] = root_position.y;
    position[IK::HR] = glm::vec3(0,0,0); lock[IK::HR] = 0; height[IK::HR] = root_position.y;
    position[IK::TL] = glm::vec3(0,0,0); lock[IK::TL] = 0; height[IK::TL] = root_position.y;
    position[IK::TR] = glm::vec3(0,0,0); lock[IK::TR] = 0; height[IK::TR] = root_position.y;
  }
